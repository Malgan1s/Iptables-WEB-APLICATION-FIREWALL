...
## Содержание
- [Основные теоретические сведения](#1-основные-теоретические-сведения)
  - [Межсетевой экран](#11-межсетевой-экран)
  - [Основные цепочки межсетевого экрана Netfilter](#12-основные-цепочки-межсетевого-экрана-netfilter)
  - [Таблицы межсетевого экрана Netfilter](#13-таблицы-межсетевого-экрана-netfilter)
  - [Пример создания правила для межсетевого экрана](#14-пример-создания-правила-для-межсетевого-экрана)
  - [Web Application Firewall](#15-web-application-firewall)
- [Практическая работа](#2-практическая-часть)
  - [Часть 1. Iptables](#часть-1-iptables)
  - [Часть 2. WAF](#часть-2-waf)
  - [Часть 3. Тестирование модуля защиты WAF](#часть-3-тестирование-модуля-защиты-waf)
...
В работе реализована комплексная защита веб-сервера: на виртуальной машине развернут Apache с ModSecurity, настроены гибкие правила iptables для фильтрации и предотвращения сетевых атак, интегрированы правила OWASP для WAF с активным режимом блокировки, после чего была проверена эффективность защиты с помощью nmap и тестовых HTTP-запросов.
